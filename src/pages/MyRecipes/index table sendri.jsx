...
const MyRecipes = () => {
  ...
  let valuePagination = `sortby=${sortBy}&sort=${sort}&page=${currentPage}&limit=${limit}`;
  // let valueSenderMyRecipes =``;
  console.log(valuePagination)

  const getUsers = async () => {
    if (keyword !== null || keyword !== undefined || keyword !== '') {
      let valueSenderMyRecipes = keywordValue + valuePagination;
       await dispatch(getMyRecipes(valueSenderMyRecipes))
        .unwrap()
        .then((item) => {
          setUsers(item.data);
          console.log(item)
      ...
      let valueSenderMyRecipes = valuePagination;
       await dispatch(getMyRecipes(valueSenderMyRecipes))
        .unwrap()
        .then((item) => {
          setUsers(item.data);
  ...
  }, [keyword,keywordValue,valuePagination]);
              ...
              <tbody>
                {MyRecipes.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td>
                      {/* <MyRecipesModalEdit idRecipes={item.id} /> */}
                    </td>
                  </tr>
                ))}
              </tbody>
